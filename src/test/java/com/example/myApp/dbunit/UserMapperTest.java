...
//        // id=3の検索結果
//        User actual = userMapper.select(3);
//        // 検証：期待値と一致していること
...
//        // 登録実行
//        //int createdCount = userMapper.insert(newUser);
//        // 検証：1件の追加に成功していること
...
//        // 更新実行
//        int updatedCount = userMapper.update(updateUser);
//        // 検証：1件の更新に成功していること
...
//    void delete() {
//        // id=1のレコードを削除
//        int deletedCount = userMapper.delete(1);
//        // 検証：1件の削除に成功していること
